...
Участвуй в игре "Ящер дня" %s, зови союзников и, главное, не доверяй тем, у кого чешуя блестит слишком сильно — тут явно ящер шпионит!`
	...
	NoParticipantsMessage     = "Ну раз уж никто не участвует, все признаны ящерами! Участвуйте в игре %s что бы защитить свою честь!"
